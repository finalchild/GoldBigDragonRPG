...
public class CreatureWither extends EntityWither {
    public CreatureWither(World world, String AI) {
        super(world);
        try {
    ...
    public static Object spawn(Location location, String AI) {
        ...
        final CreatureWither customEntity = new CreatureWither(mcWorld, AI);
