...
import net.minecraft.server.v1_12_R1.PathfinderGoalTargetNearestPlayer;

public class CreatureEnderman extends EntityEnderman {
    public CreatureEnderman(World world, String AI) {
        super(world);
        try {
    ...
    public static Object spawn(Location location, String AI) {
        ...
        final CreatureEnderman customEntity = new CreatureEnderman(mcWorld, AI);
