...
public class CreatureSpider extends EntitySpider {
    public CreatureSpider(World world, String AI) {
        super(world);
        try {
    ...
    public static Object spawn(Location location, String AI) {
        ...
        final CreatureSpider customEntity = new CreatureSpider(mcWorld, AI);
