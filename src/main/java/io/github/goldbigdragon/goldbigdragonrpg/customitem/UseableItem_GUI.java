...
public class UseableItem_Gui extends GuiUtil {
    public void UseableItemListGUI(Player player, int page) {
        ...
        Stack2(ChatColor.WHITE + "" + ChatColor.BOLD + "새 아이템", 386, 0, 1, Collections.singletonList(ChatColor.GRAY + "새로운 아이템을 생성합니다."), 49, inv);
    ...
    public void NewUseableItemGUIclick(InventoryClickEvent event) {
        ...
        if (IconName.compareTo("[        스킬        ]") == 0) {
            ...
            SoundUtil.playSound(player, Sound.BLOCK_ANVIL_LAND, 0.8F, 1.8F);
