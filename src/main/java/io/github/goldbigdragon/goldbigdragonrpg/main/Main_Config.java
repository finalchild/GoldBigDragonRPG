...
public class Main_Config {
    public void CheckConfig(YamlController YC) {
        ...
        if (Config.contains("Server.MabinogiMoneySystem"))
            Main_ServerOption.MoneySystem = Config.getBoolean("Server.MabinogiMoneySystem");
        if (Config.contains("Server.STR"))
            Main_ServerOption.STR = Config.getString("Server.STR");
        if (Config.contains("Server.DEX"))
            Main_ServerOption.DEX = Config.getString("Server.DEX");
        if (Config.contains("Server.INT"))
            Main_ServerOption.INT = Config.getString("Server.INT");
        if (Config.contains("Server.WILL"))
            Main_ServerOption.WILL = Config.getString("Server.WILL");
        if (Config.contains("Server.LUK"))
            Main_ServerOption.LUK = Config.getString("Server.LUK");
        if (Config.contains("Server.MoneyName"))
            Main_ServerOption.Money = Config.getString("Server.MoneyName");
        if (Config.contains("Server.STR_Lore"))
            Main_ServerOption.STR_Lore = Config.getString("Server.STR_Lore");
        if (Config.contains("Server.DEX_Lore"))
            Main_ServerOption.DEX_Lore = Config.getString("Server.DEX_Lore");
        if (Config.contains("Server.INT_Lore"))
            Main_ServerOption.INT_Lore = Config.getString("Server.INT_Lore");
        if (Config.contains("Server.WILL_Lore"))
            Main_ServerOption.WILL_Lore = Config.getString("Server.WILL_Lore");
        if (Config.contains("Server.LUK_Lore"))
            Main_ServerOption.LUK_Lore = Config.getString("Server.LUK_Lore");
        if (Config.contains("Server.Money.1.ID"))
            Main_ServerOption.Money1ID = (short) Config.getInt("Server.Money.1.ID");
        if (Config.contains("Server.Money.2.ID"))
            Main_ServerOption.Money2ID = (short) Config.getInt("Server.Money.2.ID");
        if (Config.contains("Server.Money.3.ID"))
            Main_ServerOption.Money3ID = (short) Config.getInt("Server.Money.3.ID");
        if (Config.contains("Server.Money.4.ID"))
            Main_ServerOption.Money4ID = (short) Config.getInt("Server.Money.4.ID");
        if (Config.contains("Server.Money.5.ID"))
            Main_ServerOption.Money5ID = (short) Config.getInt("Server.Money.5.ID");
        if (Config.contains("Server.Money.6.ID"))
            Main_ServerOption.Money6ID = (short) Config.getInt("Server.Money.6.ID");
        if (Config.contains("Server.Money.1.DATA"))
            Main_ServerOption.Money1DATA = (byte) Config.getInt("Server.Money.1.DATA");
        if (Config.contains("Server.Money.2.DATA"))
            Main_ServerOption.Money2DATA = (byte) Config.getInt("Server.Money.2.DATA");
        if (Config.contains("Server.Money.3.DATA"))
            Main_ServerOption.Money3DATA = (byte) Config.getInt("Server.Money.3.DATA");
        if (Config.contains("Server.Money.4.DATA"))
            Main_ServerOption.Money4DATA = (byte) Config.getInt("Server.Money.4.DATA");
        if (Config.contains("Server.Money.5.DATA"))
            Main_ServerOption.Money5DATA = (byte) Config.getInt("Server.Money.5.DATA");
        if (Config.contains("Server.Money.6.DATA"))
            Main_ServerOption.Money6DATA = (byte) Config.getInt("Server.Money.6.DATA");
        if (Config.contains("Server.Damage"))
            Main_ServerOption.Damage = Config.getString("Server.Damage");
        if (Config.contains("Server.MagicDamage"))
            Main_ServerOption.MagicDamage = Config.getString("Server.MagicDamage");
        ...
        if (Config.contains("Death.ReviveItem"))
            Main_ServerOption.DeathRevive = Config.getItemStack("Death.ReviveItem");
        if (Config.contains("Death.RescueItem"))
            Main_ServerOption.DeathRescue = Config.getItemStack("Death.RescueItem");
        ...
        Main_ServerOption.MaxLevel = Config.getInt("MaxStat.Level");
        Main_ServerOption.MaxSTR = Config.getInt("MaxStat.STR");
        Main_ServerOption.MaxDEX = Config.getInt("MaxStat.DEX");
        Main_ServerOption.MaxINT = Config.getInt("MaxStat.INT");
        Main_ServerOption.MaxWILL = Config.getInt("MaxStat.WILL");
        Main_ServerOption.MaxLUK = Config.getInt("MaxStat.LUK");
        Main_ServerOption.PVP = Config.getBoolean("Server.PVP");
        Main_ServerOption.MaxDropMoney = Config.getLong("Server.Max_Drop_Money");
        Main_ServerOption.EXPShareDistance = Config.getInt("Party.EXPShareDistance");

        Main_ServerOption.Event_SkillPoint = (byte) Config.getInt("Event.Multiple_Level_Up_SkillPoint");
        Main_ServerOption.Event_StatPoint = (byte) Config.getInt("Event.Multiple_Level_Up_StatPoint");
        Main_ServerOption.Event_DropChance = (byte) Config.getInt("Event.DropChance");
        Main_ServerOption.Event_Exp = (byte) Config.getInt("Event.Multiple_EXP_Get");
        Main_ServerOption.Event_Proficiency = (byte) Config.getInt("Event.Multiple_Proficiency_Get");

        Main_ServerOption.LevelUpPerSkillPoint = (byte) Config.getInt("Server.Level_Up_SkillPoint");
        Main_ServerOption.LevelUpPerStatPoint = (byte) Config.getInt("Server.Level_Up_StatPoint");
