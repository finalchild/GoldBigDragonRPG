...
public class Dungeon_SeedMaker {
    int size;//던전의 크기
                    ...
                    switch (Grid[randomroad]) {
                        case "─":
                            switch (side) {
                                case 'N':
                                    Grid[randomroad] = "┴";
                                    setRoom(randomroad, 'N', true);
                                    break;
                                case 'S':
                                    Grid[randomroad] = "┬";
                                    setRoom(randomroad, 'S', true);
                                    break;
                            }
                            break;
                        case "│":
                            switch (side) {
                                case 'E':
                                    Grid[randomroad] = "├";
                                    setRoom(randomroad, 'E', true);
                                    break;
                                case 'W':
                                    Grid[randomroad] = "┤";
                                    setRoom(randomroad, 'W', true);
                                    break;
                            }
                            break;
                        case "┌":
