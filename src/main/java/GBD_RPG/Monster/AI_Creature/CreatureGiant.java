...
public class CreatureGiant extends EntityGiantZombie {
    public CreatureGiant(World world, String AI) {
        super(world);
        try {
    ...
    public static Object spawn(Location location, String AI) {
        ...
        final CreatureGiant customEntity = new CreatureGiant(mcWorld, AI);
