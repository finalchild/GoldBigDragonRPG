...
public class CustomItem_GUI extends Util_GUI {
    ...
    public void NewItemGUI(Player player, int number) {
        ...
        Stack2(ChatColor.DARK_AQUA + "[       " + GBD_RPG.Main_Main.Main_ServerOption.Damage + "       ]", 267, 0, 1, Arrays.asList(ChatColor.WHITE + "아이템의 " + GBD_RPG.Main_Main.Main_ServerOption.Damage + "를", ChatColor.WHITE + "변경합니다.", ""), 24, inv);
        Stack2(ChatColor.DARK_AQUA + "[     " + GBD_RPG.Main_Main.Main_ServerOption.MagicDamage + "     ]", 403, 0, 1, Arrays.asList(ChatColor.WHITE + "아이템의 " + GBD_RPG.Main_Main.Main_ServerOption.MagicDamage + "를", ChatColor.WHITE + "변경합니다.", ""), 25, inv);
        ...
        if (Type.compareTo("[분류]") == 0) {
            ...
            if (ItemList.getInt(ItemNumber + ".MinLV") != 0 || ItemList.getInt(ItemNumber + ".MinRLV") != 0 ||
                ...
                if (ItemList.getInt(ItemNumber + ".MinSTR") > 0)
                    lore = lore + ChatColor.DARK_RED + " Ω 최소 " + GBD_RPG.Main_Main.Main_ServerOption.STR + " : " + ItemList.getInt(ItemNumber + ".MinSTR") + "%enter%";
                if (ItemList.getInt(ItemNumber + ".MinDEX") > 0)
                    lore = lore + ChatColor.DARK_RED + " Ω 최소 " + GBD_RPG.Main_Main.Main_ServerOption.DEX + " : " + ItemList.getInt(ItemNumber + ".MinDEX") + "%enter%";
                if (ItemList.getInt(ItemNumber + ".MinINT") > 0)
                    lore = lore + ChatColor.DARK_RED + " Ω 최소 " + GBD_RPG.Main_Main.Main_ServerOption.INT + " : " + ItemList.getInt(ItemNumber + ".MinINT") + "%enter%";
                if (ItemList.getInt(ItemNumber + ".MinWILL") > 0)
                    lore = lore + ChatColor.DARK_RED + " Ω 최소 " + GBD_RPG.Main_Main.Main_ServerOption.WILL + " : " + ItemList.getInt(ItemNumber + ".MinWILL") + "%enter%";
                if (ItemList.getInt(ItemNumber + ".MinLUK") > 0)
                    lore = lore + ChatColor.DARK_RED + " Ω 최소 " + GBD_RPG.Main_Main.Main_ServerOption.LUK + " : " + ItemList.getInt(ItemNumber + ".MinLUK") + "%enter%";
            ...
            if (ItemList.getInt(ItemNumber + ".MinSTR") > 0)
                lore = lore + ChatColor.DARK_RED + "%enter% Ω 최소 " + GBD_RPG.Main_Main.Main_ServerOption.STR + " : " + ItemList.getInt(ItemNumber + ".MinSTR");
            if (ItemList.getInt(ItemNumber + ".MinDEX") > 0)
                lore = lore + ChatColor.DARK_RED + "%enter% Ω 최소 " + GBD_RPG.Main_Main.Main_ServerOption.DEX + " : " + ItemList.getInt(ItemNumber + ".MinDEX");
            if (ItemList.getInt(ItemNumber + ".MinINT") > 0)
                lore = lore + ChatColor.DARK_RED + "%enter% Ω 최소 " + GBD_RPG.Main_Main.Main_ServerOption.INT + " : " + ItemList.getInt(ItemNumber + ".MinINT");
            if (ItemList.getInt(ItemNumber + ".MinWILL") > 0)
                lore = lore + ChatColor.DARK_RED + "%enter% Ω 최소 " + GBD_RPG.Main_Main.Main_ServerOption.WILL + " : " + ItemList.getInt(ItemNumber + ".MinWILL");
            if (ItemList.getInt(ItemNumber + ".MinLUK") > 0)
                lore = lore + ChatColor.DARK_RED + "%enter% Ω 최소 " + GBD_RPG.Main_Main.Main_ServerOption.LUK + " : " + ItemList.getInt(ItemNumber + ".MinLUK");
            ...
            if (ItemList.getInt(ItemNumber + ".MinSTR") > 0)
                lore = lore + "%enter%" + ChatColor.DARK_RED + "최소 " + GBD_RPG.Main_Main.Main_ServerOption.STR + " : " + ItemList.getInt(ItemNumber + ".MinSTR");
            if (ItemList.getInt(ItemNumber + ".MinDEX") > 0)
                lore = lore + "%enter%" + ChatColor.DARK_RED + "최소 " + GBD_RPG.Main_Main.Main_ServerOption.DEX + " : " + ItemList.getInt(ItemNumber + ".MinDEX");
            if (ItemList.getInt(ItemNumber + ".MinINT") > 0)
                lore = lore + "%enter%" + ChatColor.DARK_RED + "최소 " + GBD_RPG.Main_Main.Main_ServerOption.INT + " : " + ItemList.getInt(ItemNumber + ".MinINT");
            if (ItemList.getInt(ItemNumber + ".MinWILL") > 0)
                lore = lore + "%enter%" + ChatColor.DARK_RED + "최소 " + GBD_RPG.Main_Main.Main_ServerOption.WILL + " : " + ItemList.getInt(ItemNumber + ".MinWILL");
            if (ItemList.getInt(ItemNumber + ".MinLUK") > 0)
                lore = lore + "%enter%" + ChatColor.DARK_RED + "최소 " + GBD_RPG.Main_Main.Main_ServerOption.LUK + " : " + ItemList.getInt(ItemNumber + ".MinLUK");
        } else {
            lore = lore + ItemList.getString(ItemNumber + ".Type");
            for (int count = 0; count < 20 - ItemList.getString(ItemNumber + ".Type").length(); count++)
                lore = lore + " ";
            ...
            if (ItemList.getInt(ItemNumber + ".MinSTR") > 0)
                lore = lore + "%enter%" + ChatColor.WHITE + "최소 " + GBD_RPG.Main_Main.Main_ServerOption.STR + " : " + ItemList.getInt(ItemNumber + ".MinSTR");
            if (ItemList.getInt(ItemNumber + ".MinDEX") > 0)
                lore = lore + "%enter%" + ChatColor.WHITE + "최소 " + GBD_RPG.Main_Main.Main_ServerOption.DEX + " : " + ItemList.getInt(ItemNumber + ".MinDEX");
            if (ItemList.getInt(ItemNumber + ".MinINT") > 0)
                lore = lore + "%enter%" + ChatColor.WHITE + "최소 " + GBD_RPG.Main_Main.Main_ServerOption.INT + " : " + ItemList.getInt(ItemNumber + ".MinINT");
            if (ItemList.getInt(ItemNumber + ".MinWILL") > 0)
                lore = lore + "%enter%" + ChatColor.WHITE + "최소 " + GBD_RPG.Main_Main.Main_ServerOption.WILL + " : " + ItemList.getInt(ItemNumber + ".MinWILL");
            if (ItemList.getInt(ItemNumber + ".MinLUK") > 0)
                lore = lore + "%enter%" + ChatColor.WHITE + "최소 " + GBD_RPG.Main_Main.Main_ServerOption.LUK + " : " + ItemList.getInt(ItemNumber + ".MinLUK");
        }
