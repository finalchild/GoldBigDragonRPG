...
public class CustomItem_Command {
    ...
    public void HelpMessage(Player player) {
        ...
        player.sendMessage(ChatColor.AQUA + "/아이템 설명추가 " + GBD_RPG.Main_Main.Main_ServerOption.Damage + " : 3 ~ 6" + ChatColor.RED + " (아이템 장착시 " + GBD_RPG.Main_Main.Main_ServerOption.Damage + " 3 ~ 6 상승)");
        ...
        player.sendMessage(ChatColor.AQUA + "[" + GBD_RPG.Main_Main.Main_ServerOption.Damage + " : <숫자> ~ <숫자>] [방어 : <숫자>] [보호 : <숫자>]\n"
                + "[" + GBD_RPG.Main_Main.Main_ServerOption.MagicDamage + " : <숫자> ~ <숫자>] [마법 방어 : <숫자>] [마법 보호 : <숫자>]\n"
                + "[" + GBD_RPG.Main_Main.Main_ServerOption.STR + " : <숫자>] [" + GBD_RPG.Main_Main.Main_ServerOption.DEX + " : <숫자>] [" + GBD_RPG.Main_Main.Main_ServerOption.INT + " : <숫자>] [" + GBD_RPG.Main_Main.Main_ServerOption.WILL + " : <숫자>] [" + GBD_RPG.Main_Main.Main_ServerOption.LUK + " : <숫자>]\n"
