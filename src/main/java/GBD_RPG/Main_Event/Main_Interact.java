...
public class Main_Interact
{
	...
	public String SetItemDefaultName(short itemCode,byte itemData)
	{
		...
		switch (itemCode)
		{
			...
			case 198: return ChatColor.DARK_PURPLE+""+ChatColor.BOLD+"엔드 막대";
			case 199: return ChatColor.DARK_PURPLE+""+ChatColor.BOLD+"후렴 나무";
			case 200: return ChatColor.DARK_PURPLE+""+ChatColor.BOLD+"후렴화";
			case 201: return ChatColor.DARK_PURPLE+""+ChatColor.BOLD+"퍼퍼 블록";
			case 202: return ChatColor.DARK_PURPLE+""+ChatColor.BOLD+"퍼퍼 기둥";
			case 203: return ChatColor.DARK_PURPLE+""+ChatColor.BOLD+"퍼퍼 계단";
			case 205: return ChatColor.DARK_PURPLE+""+ChatColor.BOLD+"퍼퍼 반 블록";
			case 206: return ChatColor.WHITE+""+ChatColor.BOLD+"엔드 석재 벽돌";
			case 213: return ChatColor.RED+""+ChatColor.BOLD+"마그마 블록";
			case 214: return ChatColor.DARK_RED+""+ChatColor.BOLD+"네더 와트 블록";
			case 215: return ChatColor.DARK_RED+""+ChatColor.BOLD+"붉은 네더 벽돌";
			case 216: return ChatColor.WHITE+""+ChatColor.BOLD+"뼈 블록";
			...
			case 426: return ChatColor.LIGHT_PURPLE+""+ChatColor.BOLD+"엔드 수정";
			...
			case 432: return ChatColor.LIGHT_PURPLE+""+ChatColor.BOLD+"후렴과";
			case 433: return ChatColor.LIGHT_PURPLE+""+ChatColor.BOLD+"튀긴 후렴과";
			case 434: return ChatColor.RED+""+ChatColor.BOLD+"사탕무";
			case 435: return ChatColor.WHITE+""+ChatColor.BOLD+"사탕무 씨앗";
			case 436: return ChatColor.RED+""+ChatColor.BOLD+"사탕무 수프";
			case 437: return ChatColor.LIGHT_PURPLE+""+ChatColor.BOLD+"드래곤의 숨결";
			case 438: return ChatColor.WHITE+""+ChatColor.BOLD+"투척용 포션";
			case 439: return ChatColor.YELLOW+""+ChatColor.BOLD+"분광 화살";
			case 440: return ChatColor.WHITE+""+ChatColor.BOLD+"포션 바른 화살";
			case 441: return ChatColor.WHITE+""+ChatColor.BOLD+"잔류형 포션";
			case 442: return ChatColor.WHITE+""+ChatColor.BOLD+"방패";
			case 443: return ChatColor.WHITE+""+ChatColor.BOLD+"겉날개";
			case 444: return ChatColor.GOLD+""+ChatColor.BOLD+"가문비나무 보트";
			case 445: return ChatColor.GOLD+""+ChatColor.BOLD+"자작나무 보트";
			case 446: return ChatColor.GOLD+""+ChatColor.BOLD+"정글나무 보트";
			case 447: return ChatColor.GOLD+""+ChatColor.BOLD+"아카시아나무 보트";
			case 448: return ChatColor.GOLD+""+ChatColor.BOLD+"짙은 참나무 보트";
