...
public class Dungeon_Chat {
    ...
    private void DungeonMainChatting(PlayerChatEvent event) {
        ...
        if (u.getString(player, (byte) 0).compareTo("ND") == 0) {
            ...
            if (DungeonList.contains(Message)) {
                ...
                DungeonList.set(Message, GBD_RPG.ServerTick.ServerTick_Main.nowUTC);
                ...
                DungeonList.set("Type.Name", GBD_RPG.Main_Main.Main_ServerOption.DungeonTheme.get(0));
            ...
            if (isIntMinMax(event.getMessage(), player, 5, 50)) {
                ...
                DungeonList.saveConfig();
                s.SP(player, Sound.ENTITY_ITEM_PICKUP, 1.0F, 1.0F);
                new GBD_RPG.Dungeon.Dungeon_GUI().DungeonSetUpGUI(player, u.getString(player, (byte) 1));
                u.clearAll(player);
            }
    ...
    private void EnterCardChatting(PlayerChatEvent event) {
        ...
        if (u.getString(player, (byte) 0).compareTo("NEC") == 0) {
            ...
            u.clearAll(player);
            new GBD_RPG.Dungeon.Dungeon_GUI().DungeonListMainGUI(player, 0, 358);
            return;
            ...
            if (isIntMinMax(event.getMessage(), player, 0, 20)) {
                ...
                EnterCardConfig.saveConfig();
                s.SP(player, Sound.ENTITY_ITEM_PICKUP, 1.0F, 1.0F);
                new GBD_RPG.Dungeon.Dungeon_GUI().EnterCardSetUpGUI(player, u.getString(player, (byte) 1));
                u.clearAll(player);
            }
    ...
    private void AltarChatting(PlayerChatEvent event) {
        ...
        if (u.getString(player, (byte) 0).compareTo("NA_Q") == 0) {
            if (askOX(Message, player) == 1) {
                ...
                u.clearAll(player);
                new GBD_RPG.Dungeon.Dungeon_GUI().AltarShapeListGUI(player);
                ...
                u.clearAll(player);
                new GBD_RPG.Dungeon.Dungeon_GUI().DungeonListMainGUI(player, 0, 120);
            }
            return;
            ...
            s.SP(player, Sound.ENTITY_ITEM_PICKUP, 1.0F, 1.0F);
            new GBD_RPG.Dungeon.Dungeon_GUI().AltarSettingGUI(player, AltarName);
            u.clearAll(player);
        }
    }
